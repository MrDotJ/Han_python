...
def get_config():
    ...
    upper_chp_HEAT = np.array([
        ...
        [0.428 * 1,     0.4 * 1,       0.45 *  1,     0 * 1],
        [0.228 * 1,     0.2 * 1,       0.045 * 1,     0 * 0],
    ])*1
    ...
    #  start     end       weymouth     linepack   index   is_active   flow_min   flow_max
        [5,       3,        0.193/0.193,       0.1,     0,       0,           0,        20 ],
        [4,       3,        0.193/0.193,       0.1,     1,       0,           0,        20 ],
        [3,       2,        0.193/0.193,       0.1,     2,       0,           0,        20 ],
        [2,       1,        0.193/0.193,       0.1,     3,       0,           0,        20 ],
        [1,       0,        0.193/0.193,       0.1,     4,       0,           0,        20 ],
    ])
