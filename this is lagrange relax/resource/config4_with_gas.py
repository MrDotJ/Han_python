...
def get_config():
    ...
    lower_chp_info = np.array([
        [
            2 * 0.6,   0 * 0.06,     1. * 0.06,   .0 * 0.6,    0. * 0.6,      0.0 * 0.6,            0
        ],
        [
    ...
    #  start     end       weymouth     linepack   index   is_active   flow_min   flow_max
        [5,       3,        0.193/0.01,       0.0,     0,       0,           0.1,        3 ],
        [4,       3,        0.193/0.01,       0.0,     1,       0,           0.1,        3 ],
        [3,       2,        0.193/0.01,       0.0,     2,       0,           0.1,        3 ],
        [2,       1,        0.193/0.01,       0.0,     3,       0,           0.1,        3 ],
        [1,       0,        0.193/0.01,       0.0,     4,       0,           0.1,        3 ],
    ])
